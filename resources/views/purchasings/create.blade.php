...
<div class="cotainer">
    <div class="row justify-content-center">
        ...
        @endif
        <div class="col-md-8">
            <form action="{{ route('purchasings.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                            ...
                            <input type="date" name="date_purchase" class="form-control" placeholder="Date Purchase">
                            @error('date_purchase')
                            <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                            @enderror
                        </div>
