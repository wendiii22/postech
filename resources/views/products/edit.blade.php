                  ...
                  <div class="card-body">
                       ...
                       <form action="{{ route('products.update', $product->id ) }} " method="POST">
                          ...
                          <div class="form-group row mt-3">
                              ...
                              <div class="col-md-6">
                                  <input type="text" id="product_name" class="form-control" name="product_name" value="{{$product->product_name}}" required autofocus >
                          ...
                          <div class="form-group row mt-3">
                              ...
                              <div class="col-md-6">
                                  <input type="text" id="selling_price" class="form-control" name="selling_price" value="{{$product->selling_price}}" required>
                          ...
                          <div class="form-group row mt-3">
                              ...
                              <div class="col-md-6">
                                  <input type="text" id="buying_price" class="form-control" name="buying_price" value="{{$product->buying_price}}" required>
